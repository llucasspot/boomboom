...
export function ItsAMatch({ onClose, matchedUser }: ItsAMatchProps) {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View
        style={{ flex: 2, justifyContent: "flex-end", paddingVertical: 20 }}
      >
        <View style={{ alignItems: "center" }}>
          <View style={styles.floating_hearts_container as ViewStyle}>
            <Image
              source={IMAGES.matching.floating_hearts}
              style={styles.image_floating_hearts as ImageStyle}
            />
          </View>
          <View
            style={{ flexDirection: "row", height: 494 / 2, width: "100%" }}
          >
            <Animated.View
              style={{ flex: 1, transform: [{ translateX: translateXInner }] }}
            >
              <Animated.Image
            ...
            <Animated.View
              style={{
                flex: 1,
                transform: [
                  { translateX: Animated.multiply(translateXInner, -1) },
                ],
              }}
            >
              <Animated.Image
