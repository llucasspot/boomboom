...
export function BlurredAura({color, position}: BlurredAuraProps) {
    ...
    return (
        <View style={{width: '100%', height: '100%', overflow: 'hidden', position: 'absolute'}}>
            <Image source={image} style={{width: 1024, height: 1024, ...stylePosition, position: 'absolute'}}/>
        </View>
    );
}
