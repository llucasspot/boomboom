...
import {RegistrationStack, RegistrationStackScreenParamsList} from "../navigation/RegistrationStack/RegistrationStack";
import {createNavigationContainerRef, NavigationContainer, RouteProp} from "@react-navigation/native";
...
export function ScreenStepperLayout({
    ...
    const nestedNavigationRef = createNavigationContainerRef<RegistrationStackScreenParamsList>()
    ...
    return (
        <SafeAreaView style={styles.mainContainer}>
            <View style={styles.header}>
                ...
                />
                <View>
                    <Text style={{...coreStyles.P, ...styles.stepTitle}}>{I18n.t('common.stepperHeader', { step: step+1, numberOfStep })}</Text>
                                ...
                                {(props) => {
                                    return (
                                        <View style={styles.content}>
                                            <Child setStepperLayoutCallback={setStepperLayoutCallback} />
                                        </View>
                                    )
                                }}
                            </RegistrationStack.Screen>
