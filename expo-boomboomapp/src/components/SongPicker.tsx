import {Image, ScrollView, Text, TextInput, TextStyle, TouchableOpacity, View} from "react-native";
...
import {SpotifyApiServiceI, Track} from "../api/SpotifyApiService/SpotifyApiServiceI";
                ...
                <View style={styles.searchBarContainer}>
                    <View style={styles.view}>
                        <TextInput
                            ...
                            autoFocus={true}
                            placeholder={I18n.t('screen.searchBarPlaceholder.searchBarPlaceholder')}
                    ...
                    (
                        <ScrollView>
                            <View style={styles.fetchedSongsContainer}>
                                {fetchedSongs
                                    .filter(song => !mySongs.find(mySong => mySong.name === song.name))
                                    .map((song, index) =>
                                        <SongCard song={song} key={song.name} icon={() =>
                                            <BaseButton icon={IconName.PLUS} onPress={() => pick(song)}/>
                                        }/>
                                    )}
                            </View>
                        </ScrollView>
                        ...
                        <View style={styles.emptyFetchedSongsContainer}>
                            <View style={styles.imageContainer}>
                                ...
                                <Text style={{textAlign: 'center', ...coreStyles.P}}>
                                    Your mate will love your songs.
                                    Choose
                                    wisely!
                                </Text>
                            </View>
